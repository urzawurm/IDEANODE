...
import { getAdmin, postAdmin, getWarehouse, deleteProduct, updateProduct, getEditProduct,getUpdateAdmin } from "../controllers/adminController.js"; 

const router = express.Router();

router.route("/").get(getAdmin).post(postAdmin);
router.route("/update").get(getUpdateAdmin).post(postAdmin);
